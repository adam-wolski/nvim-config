...
local groups = {
  ...
  CurSearch = { fg = colors.amber, bg = colors.black, reverse = true },
  ...
  DiffText = { fg = colors.amber, bg = colors.black, reverse = true },
  ...
  PmenuMatch = { fg = colors.black, bold = true },
  ...
  QuickFixLine = { fg = colors.amber, bg = colors.black, reverse = true },
  ...
  Statement = { fg = colors.silver },
  Todo = { fg = colors.mint, bold = true, reverse = true },
  Type = { fg = colors.gray_light },
