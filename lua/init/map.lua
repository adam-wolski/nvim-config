...
nmap('<F4>',    ":lua require'dapui'.open()<CR>")
nmap('<S-F4>',  ":lua require'dapui'.close()<CR>")
nmap('<F5>',    ":lua require'dap'.continue()<CR>")
nmap('<S-F5>',  ":lua require'dap'.pause(0)<CR>")
nmap('<F10>',   ":lua require'dap'.step_over()<CR>")
nmap('<S-F10>', ":lua require'dap'.run_to_cursor()<CR>")
nmap('<F11>',   ":lua require'dap'.step_into()<CR>")
nmap('<S-F11>', ":lua require'dap'.step_out()<CR>")
nmap('<F9>',    ":lua require'dap'.toggle_breakpoint()<CR>")
nmap('<S-F9>',  ":lua require'dap'.set_breakpoint(vim.fn.input('Breakpoint condition: '))<CR>")
nmap('<F12>',   ":lua require'dap'.repl.open()<CR>")
nmap('<S-F12>', ":lua require'dap'.run_last()<CR>")
